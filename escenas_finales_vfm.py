...
class IntroErwin(Scene):
    ...
    def construct(self):
        ...
        self.play(
           LaggedStart(*map(FadeOutAndShiftDown, image))
        )
        ...
        self.play(
            LaggedStart(*map(FadeOutAndShiftDown, transform_title)),
            LaggedStart(*map(FadeOutAndShiftDown, transform_text)),
            LaggedStart(*map(FadeOutAndShiftDown, text_2)),
            LaggedStart(*map(FadeOutAndShiftDown,title)),
            LaggedStart(*map(FadeOutAndShiftDown,text)),
            LaggedStart(*map(FadeOutAndShiftDown, text_3)),
        )
        self.wait(2)
...
class IntroEcuation(Scene):
    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(*map(FadeOutAndShiftDown, text)),
            LaggedStart(*map(FadeOutAndShiftDown, framebox1)),
            LaggedStart(*map(FadeOutAndShiftDown, framebox2)),
            LaggedStart(*map(FadeOutAndShiftDown, framebox3)),
            LaggedStart(*map(FadeOutAndShiftDown, t1)),
            LaggedStart(*map(FadeOutAndShiftDown, t2)),
            LaggedStart(*map(FadeOutAndShiftDown, t3)),
        )
        self.wait(2)
...
class PlotOrbitalS(ThreeDScene):
    ...
    def construct(self):
        axes = ThreeDAxes()
        text3d = TextMobject("Orbital S en el hidrógeno")
        ...
        self.add(axes)
        self.play(LaggedStart(*map(ShowCreation, sphere)), ShowCreation(axes), ShowCreation(text3d))
...
class PlotWave(GraphScene):
    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(*map(FadeOutAndShiftDown, func_graph2)),
            LaggedStart(*map(FadeOutAndShiftDown, n_1)),
        )
        ...
        self.play(
            LaggedStart(*map(FadeOutAndShiftDown, func_graph)),
            LaggedStart(*map(FadeOutAndShiftDown, func_graph2)),
            LaggedStart(*map(FadeOutAndShiftDown, n_2)),
        )
        self.wait(2)
...
class S04_3D_Cassini_Oval(ThreeDScene):
    ...
    def construct(self):
        ...
        self.play(
            ...
            LaggedStart(*map(FadeOutAndShiftDown,cassini_oval_x))
